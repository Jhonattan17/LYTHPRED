  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/Jhonattan17/LYTHPRED/blob/main/app.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "cgs_wgEZSL3P",
        "outputId": "523c4300-b79b-4997-c83d-da9095cf84ef"
      },
      "outputs": [
        {
          "output_type": "stream",
          ...
          "text": [
            ...
            "Requirement already satisfied: sktime>=0.16.1 in /usr/local/lib/python3.9/dist-packages (from pycaret) (0.17.1)\n",
            "Requirement already satisfied: xxhash in /usr/local/lib/python3.9/dist-packages (from pycaret) (3.2.0)\n",
            "Requirement already satisfied: tbats>=1.1.0 in /usr/local/lib/python3.9/dist-packages (from pycaret) (1.1.3)\n",
            "Requirement already satisfied: importlib-metadata>=4.12.0 in /usr/local/lib/python3.9/dist-packages (from pycaret) (6.4.1)\n",
            ...
            "Requirement already satisfied: dash<3.0.0,>=2.2.0 in /usr/local/lib/python3.9/dist-packages (from plotly-resampler>=0.8.3.1->pycaret) (2.9.3)\n",
            "Requirement already satisfied: orjson<4.0.0,>=3.8.0 in /usr/local/lib/python3.9/dist-packages (from plotly-resampler>=0.8.3.1->pycaret) (3.8.10)\n",
            "Requirement already satisfied: trace-updater>=0.0.8 in /usr/local/lib/python3.9/dist-packages (from plotly-resampler>=0.8.3.1->pycaret) (0.0.9.1)\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "T8O9Pjj4SQqs",
        "outputId": "f5f66414-3593-4077-fe35-ec009952a98d"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "1QAWNGCJSUKh",
        "outputId": "af442b56-803e-471a-e24f-1deafd005cfc"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "0fQE-KBjI_sz",
        "outputId": "6fcee1f6-f8e8-4847-ef77-01e6eca1c09b"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "W6YG1o19eRqE",
        "outputId": "60783bc9-ea81-485c-8dd4-5c8452fc977b"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "OHEOgp1oJ5_7",
        "outputId": "e8092b5a-17a2-4b2c-cc44-7559949263d3"
      },
      "outputs": [
        {
          "name": "stdout",
          ...
          "text": [
            ...
            "\u001b[34m  External URL: \u001b[0m\u001b[1mhttp://35.229.55.113:8501\u001b[0m\n",
            "\u001b[0m\n",
